...
void wxGameList::UpdateItemColors(sint32 startIndex)
{
	...
	wxColour bgColourPrimary = wxHelper::getBackgroundPrimary(); // color for odd rows
	wxColour bgColourSecondary = wxHelper::getBackgroundSecondary(); // color for even rows
